...
async def button(update: Update, context: CallbackContext):
    ...
    if query.data == "end_quest_button":
        if a >= 18:
            await query.edit_message_text(text=f"Ваш результат: {a} баллов из 20. Хороший результат!")
        if a < 18:
            await query.edit_message_text(text=f"Ваш результат: {a} баллов из 20. Проходной балл от 18. \nПодучи правила, чтобы сдать на более лучший результат! ")
